...
print("DROP TABLE Player; \nCREATE TABLE Player (Player_id INT, Name VARCHAR(20), Nationality VARCHAR(20), Age INT, Team VARCHAR(40), Overall INT);")

total_rows = personal_data.shape[0]

#for i in range(0,total_rows):
#	print("INSERT into Player values (", personal_data["ID"][i], ",", personal_data["Name"][i], ",", personal_data["Nationality"][i], ",", personal_data["Age"][i], ",", personal_data["Club"][i], ")")
for i in range(0,total_rows):
	print("INSERT into Player values (", str(personal_data["ID"][i]), ", ", '"', personal_data["Name"][i], '"', ", ", '"', personal_data["Nationality"][i], '"', ", ", personal_data["Age"][i], ", ", '"', personal_data["Club"][i], '"', ", ",personal_data["Overall"][i], ");",sep="")
